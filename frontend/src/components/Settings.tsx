            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  value={settings?.defaultHourlyRate || 0}
                  onChange={(e) =>
                    handleChange('defaultHourlyRate', parseFloat(e.target.value))
                  }
                />
              </Grid>
              <Grid item xs={12} sm={4}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={settings?.invoiceNumber || 1}
                  onChange={(e) =>
                    handleChange('invoiceNumber', parseInt(e.target.value))
                  }
                />
              </Grid>
            </Grid>
